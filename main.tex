...
\DocumentMetadata{lang=zh-CN,pdfversion=1.7}
\documentclass[a4paper,twoside,onecolumn,12pt,fontset=none,UTF8,notitlepage]{ctexrep}
\usepackage{fancyhdr,titlesec}%标题、脚注格式
\usepackage{luacolor, xcolor}%颜色
\usepackage[soul]{lua-ul}%下划线与其他装饰
\usepackage[draft]{graphicx}%插入图片
...
\usepackage[draft, bookmarksnumbered=true, hidelinks]{hyperref}%超链接
...
% 设置文档标题
\hypersetup{%
    pdftitle = {山二医指南（部分） SDSMU-Companion-Part},%
