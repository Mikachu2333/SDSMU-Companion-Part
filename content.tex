...
\begin{enumerate}
    ...
    \item 选定软件
          \begin{enumerate}
              \item 使用\textbf{Microsoft® Office套件}（2016及以上版本），或\textbf{金山办公® WPS Office套件}（2018及以上版本），\textbf{禁用}永中Office、LibreOffice、OpenOffice、腾讯文档（及小程序）、金山文档小程序、石墨文档、语雀等，除非你精通电脑使用且可以解决你遭受的所有问题
              \item 所有组员应使用相同系列的软件进行制作（例如统一使用“WPS”套件或统一使用“Office”套件等）
          \end{enumerate}
    \item 内容制作\\
          先制作大体框架，再填充内容，最后排版
    \item 保存
